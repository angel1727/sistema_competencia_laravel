                ...
                <div class="col-md-4">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body text-center">
                            <button class="btn btn-success w-100 mb-2" data-toggle="modal"
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6 mb-4">
                                            <div class="card h-100 shadow-lg border-0 rounded-4 card-selectable position-relative">
                                                ...
                                                <div class="form-check top-0 end-0 m-2">
                                                    <input class="form-check-input seleccionPostulante"
                                                ...
                                                <div class="card-body p-3"
                                                    ...
                                                    <br>
                                                    <p class="mb-1"><i
                                                            class="fas fa-file-alt me-1 text-muted"></i><strong>CI:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-map-marker-alt me-1 text-muted"></i><strong>Ciudad:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-home me-1 text-muted"></i><strong>Dirección:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-envelope me-1 text-muted"></i><strong>Email:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-mobile-alt me-1 text-muted"></i><strong>Móvil:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-phone me-1 text-muted"></i><strong>Fijo:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-money-bill me-1 text-muted"></i><strong>NIT:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-building me-1 text-muted"></i><strong>Registro
                                                            SIGEP:</strong></p>
                                                    <p class="mb-1"><i
                                                            class="fas fa-briefcase me-1 text-muted"></i><strong>Matrícula:</strong></p>
                                                    <p class="mb-1"><i
                                                    ...
                                                    <p class="mb-3"><i
                                                            class="fas fa-calendar-check me-1 text-muted"></i><strong>Registrado:</strong></p>
